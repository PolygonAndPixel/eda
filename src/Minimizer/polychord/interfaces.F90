...
contains
    ...
    subroutine polychord_c_interface( &
        ...
        ! write(*,*) write_resume, ", ", write_paramnames, ", ", read_resume
        ! write(*,*) write_stats, ", ", write_live, ", ", write_dead
        ! write(*,*) write_prior, ", ", update_files, ", ", nDims
        allocate(settings%grade_frac(nGrade),settings%grade_dims(nGrade))
        ! write(*,*) nlive, ", ", num_repeats, ", ", nprior
        ! write(*,*) do_clustering, ", ", feedback, ", ", precision_criterion
        ! write(*,*) boost_posterior, ", ", convert_c_string(base_dir)
        ! write(*,*) equals
        ! flush(6)
